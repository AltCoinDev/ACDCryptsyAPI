#
#  Be sure to run `pod spec lint ACDCryptsyAPI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A very basic implementation of the authenticated methods of the Cryptsy API:
                     * See: https://www.cryptsy.com/pages/api for more information
  ...
  # s.authors      = { "AltCoinDev" => "email@address.com", "other author" => "email@address.com" }
  # s.author       = 'AltCoinDev', 'other author'
